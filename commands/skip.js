...
module.exports.run = async(client, msg, args) => {
    ...
    if (!msg.member.voiceChannel) return msg.channel.send(`${utils.error} No estas en un chat de voz!`);
    if (!serverQueue) return msg.channel.send(`${utils.error} No hay nada que reproducir!`);
    serverQueue.connection.dispatcher.end(`${utils.info} Salteando a la siguiente cancion...`);
    return undefined;
}
